...
<body>
	...
	<form action="edit-p-mhs.php" method="post">
		...
		<table cellpadding="3" cellspacing="0">
			...
			<tr>
				<td>Program Studi</td>
				<td>:</td>
				<td><input type="text" name="prodi" size="30" value="<?php echo $data['prodi']; ?>" required></td> <!-- value diambil dari hasil query -->
			</tr>
			<tr>
				<td>Angkatan</td>
				<td>:</td>
				<td><input type="text" name="angkatan" size="30" value="<?php echo $data['angkatan']; ?>" required></td> <!-- value diambil dari hasil query -->
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td></td>
