...
//Script Upload File..
    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
		//$matkul = 'Matematika';
        $import= mysql_query('INSERT into pilihanganda (kd_matkul,nomor,soal,a,b,c,d,kunci,tanggal,jenis) values 
		("'.$kd_matkul.'","'.$data[0].'","'.$data[1].'","'.$data[2].'","'.$data[3].'","'.$data[4].'","'.$data[5].'","'.$data[6].'",
...
<!-- Form Untuk Upload File CSV-->
	<div id="login">
					...
					<center>nomor,soal,pilihan A, B, C, D, dan kunci</center>
